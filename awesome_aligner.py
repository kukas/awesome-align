...
class AwesomeAligner():
    def __init__(self, model_name_or_path, extraction="softmax", align_layer=8, softmax_threshold=0.001, cache_dir=None, seed=0):
        ...
        empty_sent = ''
        self.empty = (0, empty_tensor, empty_tensor, [], [], empty_sent, empty_sent)
